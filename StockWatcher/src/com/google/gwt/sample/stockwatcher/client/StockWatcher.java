...
public class StockWatcher implements EntryPoint {
	...
	public void onModuleLoad() {
	    ...
	    addStylesToElementsInStockList();
	    assembleAddStockPanel();
		assembleMainPanel();
		associateMainPanelWithHtmlHostPage();
		setCursorFocusToInputBox();
		setupTimerToRefreshListAutomatically();
		listenForMouseEventsOnAddButton();
		listenForKeyboardEventOnInputBox();
	}
	...
	private void associateMainPanelWithHtmlHostPage() {
	...
	private void listenForKeyboardEventOnInputBox() {
	...
	private boolean stockAlreadyWatched(String symbol) {
